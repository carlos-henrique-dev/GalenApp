...
const list = [
	...
	},
	{
		...
		image: 'https://threebearsalaska.com/wp/wp-content/uploads/2017/04/Kenai-Pharmacy-e1492647043464.jpg',
		location: 'http://www.refletcalor.com.br/files/mapa%20cambuci%20(1).jpg'
	}
];
			...
			<View style={styles.container}>
				<FlatList
					...
					renderItem={({ item }) => (
						<PharmacyCard
							data={item}
							navigate={() => this.props.navigation.navigate('PharmacyDetails', { data: item })}
						/>
					)}
				/>
			</View>
