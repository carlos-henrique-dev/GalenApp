			...
			<View style={styles.container}>
				<View style={styles.imageContainer}>
					{this.state.data.image ? (
						<Image resizeMode="stretch" source={{ uri: this.state.data.image }} style={styles.image} />
					) : (
				...
				<View style={styles.detailContainer}>
						...
						<View>
							{this.state.data.contact.tel ? (
								<View style={{ flexDirection: 'row' }}>
									...
									<Text style={styles.telCelNumber}>{this.state.data.contact.tel}</Text>
								</View>
							) : null}
						</View>
						<View>
							{this.state.data.contact.cel ? (
								<View style={{ flexDirection: 'row' }}>
									...
									<Text style={styles.telCelNumber}>{this.state.data.contact.cel}</Text>
								</View>
							) : null}
						</View>
					</View>
					<View>
						...
						<View style={{ flexDirection: 'row' }}>
							...
							<Text style={styles.addressContent}>{this.state.data.address.neighbourhood}</Text>
						</View>
						<View style={{ flexDirection: 'row' }}>
