      ...
      <View style={styles.container}>
        <View style={styles.textArea}>
          ...
          <TextInput
            ...
            onChangeText={drugstorename => this.setState({ drugstorename: drugstorename })}
          />
        </View>
        <View style={styles.textArea}>
          {this.state.contact !== "" ? <Text style={styles.text}> Contato * </Text> : null}
          <TextInput
            placeholder="Contato *"
            style={styles.textInput}
        ...
        <View style={styles.numberNeighborArea}>
          {this.state.neighborhoodName !== "" ? <Text style={styles.text}> Bairro * </Text> : null}
          <TextInput
            placeholder="Bairro *"
            style={[styles.textInput, { width: (width * 65) / 100 }]}
            value={this.state.neighborhoodName}
            placeholderTextColor={colors.queenblue}
            onChangeText={neighborhoodName => this.setState({ neighborhoodName: neighborhoodName })}
          />
          <View>
            {this.state.number !== "" ? <Text style={styles.text}> Número </Text> : null}
            <TextInput
              placeholder="Número"
